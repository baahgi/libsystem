    ...
    <div class="flex">
        ...
        <div class="flex-1 mt-4 ml-6 mr-2">
            <div class="flex items-center justify-between">
                <h3 class="my-3 text-xl font-semibold">Books Borrowed History</h3>
                <p class="text-xs">
               <span class="mr-6 text-gray-700">ID: {{ Auth::user()->student_id }}</span>      Home  > borrows
                </p>
            </div>
                        ...
                        <tbody class="bg-white">
                            ...
                            <td class="flex px-6 py-4 space-x-2 whitespace-no-wrap border-b border-gray-200">
                                ...
                                <div class="text-sm leading-5 text-blue-500">
                                  You have not returned this book
                              </div>
                              @else
                                <div class="text-sm leading-5 text-green-500">
                                  You have return this book
                              </div>
                              @endif
                            </td>
