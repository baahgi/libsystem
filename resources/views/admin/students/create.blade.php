                ...
                <div class="flex flex-wrap justify-center">
                    <div class="w-full max-w-sm">
                        <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                            ...
                            <form class="w-full p-6" method="POST" action="{{ route('students.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="flex flex-wrap mb-6">
                                    ...
                                    <input id="name" type="text" class="form-input w-full @error('name')  border-red-500 @enderror" name="name" value="{{ old('name') }}" >
                                ...
                                <div class="flex flex-wrap mb-6">
                                    <label for="type_of_user" class="block mb-2 text-sm font-bold text-gray-700">
                                        {{ __('Type of User') }}:
                                    </label>

                                    <select name="type_of_user" id="type_of_user" class="w-full form-select">
