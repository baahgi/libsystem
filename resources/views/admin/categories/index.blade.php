                        ...
                        <tbody class="bg-white">
                            ...
                            <tr>
                              <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                  <div class="text-sm font-medium leading-5 text-gray-900 capitalize">{{ $c->name }}</div>
                              </td>

                            <td class="flex px-6 py-4 space-x-8 whitespace-no-wrap border-b border-gray-200">
